...
i=first_number#Присвоєння типовій змінній і значення першого числа
...
number_of_zeros=int(input())#Введення числа користувачем
sum=0#Присвоєння змінній значення 0
for i in range(number_of_zeros):#Цикл від 0 до числа, що введе користувач
    number=int(input())#Введення числа користувачем
