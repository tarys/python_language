...
line = [input() for counter in range(n)]
massive = (' '.join(line)).split()
massive = [int(counter) for counter in massive]
print(((massive.index(max(massive))) // m), (massive.index(max(massive))) // n)
#------------ -----------------------------------------------------------------
...
'''
size = int(input())
massive = [['.'] * size for counter in range(size)]
for counter in range(size):
    massive[counter][counter] = '*'
    massive[size // 2][counter] = '*'
    massive[counter][size // 2] = '*'
    massive[counter][size - counter - 1] = '*'
for row in matrix:
    print(' '.join(row))
#------------ -----------------------------------------------------------------
