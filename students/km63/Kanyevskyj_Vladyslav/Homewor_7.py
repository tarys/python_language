...
#task4------------------------------------------------------------
"""
Äàíî ÷èñëî n. Ñîçäàéòå ìàññèâ ðàçìåðîì n?n è çàïîëíèòå åãî ïî ñëåäóþùåìó ïðàâèëó. Íà ãëàâíîé äèàãîíàëè äîëæíû áûòü çàïèñàíû ÷èñëà 0. 
Íà äâóõ äèàãîíàëÿõ, ïðèëåãàþùèõ ê ãëàâíîé, ÷èñëà 1. Íà ñëåäóþùèõ äâóõ äèàãîíàëÿõ ÷èñëà 2, è ò.ä. 
"""
size = int(input())
matrix = [0] * size
for i in range(size):
