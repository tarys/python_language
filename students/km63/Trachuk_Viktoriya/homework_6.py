...
Определите, какие кегли остались стоять на месте.
 ...
 если j-я кегля осталась стоять, или “.”, если j-я кегля была сбита.
                    ...
                    For
                    I in range(int(count_of_shots)):
                    Start_pos, final_pos = input().splint()
                    For
                    j in range(int(start_pos) - 1, int(final_pos)):
                    List_[j] =�.�
...
Если ферзи не бьют друг друга, выведите слово NO, иначе выведите YES.
                    ...
                    def horizontal_vertical_test(
                            list_):  # this function make a test. If ion horizontal and vertical we have only 1 queen function retur 1, else 0.(created by me)
                        for i in range(len(list_)):
                            sum_of_horizontal = 0
                            sum_of_vertical = 0
                    ...
                    for i in range(
                            8):  # This is part of code where we read a coordinat's of Queen on the chess board(created by me)
                        i, j = input().split()
